...
<body>
    ...
    <div class="cont-1">
        ...
        <p class="price">Senior Veterinarian</p>
        <p class="loc">Addres: Groovy Pet Center Radio, Jl. Radio III No.1, RT.1/RW.4, Kramat Pela, Kec. Kby. Baru, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12130</p>

        <div class="cont-2">
            <p>Pet's Information</p>
        </div>

        <form method="POST" action="{{ route('VetAppointment2.store') }}" enctype="multipart/form-data" class="booking">
            @csrf
           <div>
