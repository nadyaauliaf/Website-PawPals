...
<body>
    ...
    <div class="cont-1">
        ...
        <p class="loc">Addres: Jakarta Vet, Jl. Cideng Timur No.11 H, Petojo Utara, Kec. Gambir, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta | 10130</p>

        <div class="cont-2">
            <p>Pet's Information</p>
        </div>

        <form method="POST" action="{{ route('VetAppointment1.store') }}" enctype="multipart/form-data" class="booking">
            @csrf
           <div>
