...
<body>
    ...
    <div class="cont-1">
        <img src="{{ asset('image/petHotel-2.png') }}" alt="">
        <h1>Noel Pet Shop</h1>
        <div class="star-1">
        ...
        <form method="POST" action="{{ route('BookingPetHotel2.store') }}" enctype="multipart/form-data" class="booking">
            @csrf
           <div>
